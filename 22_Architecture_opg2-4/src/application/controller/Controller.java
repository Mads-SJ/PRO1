...
public class Controller {
    ...
    public static void setEmploymentYearForEmployee(Employee employee, int employmentYear) {
        employee.setEmploymentYear(employmentYear);
    }
    ...
    public static void initStorage() {
        ...
        Controller.createEmployee("Alice Schmidt", 250, c1, 2008);
        Controller.createEmployee("George Down", 150, c2, 2022);

        Controller.createEmployee("Rita Uphill", 300);

        c1.addCustomer(Controller.createCustomer("Mads"));
        c2.addCustomer(Controller.createCustomer("Sarah"));
    }
