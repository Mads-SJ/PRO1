...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println(c1.getName() + " køber for " + c1.totalBuyWithDiscount() + " kr. med discount");
        System.out.println();
        System.out.println(c2.getName() + " køber for " + c2.totalBuy() + " kr. uden discount");
        System.out.println(c2.getName() + " køber for " + c2.totalBuyWithDiscount() + " kr. med discount");
    }
}
